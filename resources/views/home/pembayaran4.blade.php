...
<div class="page-wrapper">
    <?php
        ...
        $hero = [
            'logo' => asset('images/valorant.png'),
            'title' => 'Valorant',
            'vendor' => 'Riot Games',
            'chips' => ['Android', 'iOS', 'PC']
        ];

        // Daftar produk/nominal yang bisa Anda atur secara manual (gambar, judul, harga)
        $produkTopup = [
            [ 'src' => asset('images/vp-valorant.png'), 'title' => '475 Valorant Point', 'price' => 'IDR 56.000' ],
            [ 'src' => asset('images/vp-valorant.png'), 'title' => '1000 Valorant Point', 'price' => 'IDR 112.000' ],
            [ 'src' => asset('images/vp-valorant.png'), 'title' => '2050 Valorant Point', 'price' => 'IDR 224.000' ],
            [ 'src' => asset('images/vp-valorant.png'), 'title' => '3650 Valorant Point', 'price' => 'IDR 389.000' ],
            [ 'src' => asset('images/vp-valorant.png'), 'title' => '5350 Valorant Point', 'price' => 'IDR 559.000' ],
            [ 'src' => asset('images/vp-valorant.png'), 'title' => '11000 Valorant Point', 'price' => 'IDR 1.099.000' ],
        ];
    ?>
    ...
    <div class="layout">
        ...
        <div class="left-col">
            <!-- Step 1 -->
            <div class="panel">
                <div class="panel-title"><span class="step-badge">1</span> Masukkan Riot ID</div>
                <div class="row" style="margin-bottom: 10px;">
                    <input class="input" type="text" placeholder="Masukkan Riot ID">
                </div>
                <div class="muted">Untuk menemukan Riot ID Anda, masuk aplikasi dan lihat pada profil Anda.</div>
            </div>
        ...
        <div class="right-col">
            ...
            <div class="panel" style="margin-top: 14px;">
                <div style="font-weight:800; margin-bottom:8px;">Bagaimana Cara Top up Valorant Point?</div>
