...
<div class="page-wrapper">
    <?php
        ...
        $hero = [
            'logo' => asset('images/mobile-legend.png'),
        ...
        $produkTopup = [
            [ 'src' => asset('images/ml-diamond.png'), 'title' => '3 Diamonds', 'price' => 'IDR 1.171' ],
            [ 'src' => asset('images/ml-diamond.png'), 'title' => '5 Diamonds', 'price' => 'IDR 1.423' ],
            [ 'src' => asset('images/ml-diamond.png'), 'title' => '12 Diamonds', 'price' => 'IDR 3.323' ],
            [ 'src' => asset('images/ml-diamond.png'), 'title' => '19 Diamonds', 'price' => 'IDR 5.233' ],
            [ 'src' => asset('images/ml-diamond.png'), 'title' => '44 Diamonds', 'price' => 'IDR 11.400' ],
            [ 'src' => asset('images/ml-diamond.png'), 'title' => '59 Diamonds', 'price' => 'IDR 15.200' ],
            [ 'src' => asset('images/ml-diamond.png'), 'title' => '85 Diamonds', 'price' => 'IDR 21.850' ],
            [ 'src' => asset('images/ml-diamond.png'), 'title' => '2010 Diamonds', 'price' => 'IDR 475.000' ],
        ];
    ?>
    ...
    <div class="layout">
        ...
        <div class="left-col">
            <!-- Step 1 -->
            <div class="panel">
                <div class="panel-title"><span class="step-badge">1</span> Masukkan User ID dan Zone ID</div>
                <div class="row" style="margin-bottom: 10px;">
                    <input class="input" type="text" placeholder="Masukkan User ID">
                    <input class="input" type="text" placeholder="Masukkan Zone ID">
                </div>
                <div class="muted">Untuk menemukan User ID dan Zone ID Anda, masuk aplikasi dan lihat pada profil Anda.</div>
            </div>
