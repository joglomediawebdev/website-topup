...
<div class="page-wrapper">
    <?php
        ...
        $hero = [
            'logo' => asset('images/genshin.png'),
            'title' => 'Genshin Impact',
            'vendor' => 'HoYoverse',
            'chips' => ['Android', 'iOS', 'PlayStation 5']
        ];

        // Daftar produk/nominal yang bisa Anda atur secara manual (gambar, judul, harga)
        $produkTopup = [
            [ 'src' => asset('images/crystal.png'), 'title' => '980 Genesis Crystals', 'price' => 'IDR 16.000' ],
            [ 'src' => asset('images/crystal.png'), 'title' => '3880 Genesis Crystals', 'price' => 'IDR 16.000' ],
            [ 'src' => asset('images/crystal.png'), 'title' => '2240 Genesis Crystals', 'price' => 'IDR 16.000' ],
            [ 'src' => asset('images/crystal.png'), 'title' => '1290 Genesis Crystals', 'price' => 'IDR 16.000' ],
            [ 'src' => asset('images/crystal.png'), 'title' => '330 Genesis Crystals', 'price' => 'IDR 16.000' ],
            [ 'src' => asset('images/crystal.png'), 'title' => '60 Genesis Crystals', 'price' => 'IDR 16.000' ],
            [ 'src' => asset('images/crystal.png'), 'title' => '980 Genesis Crystals', 'price' => 'IDR 16.000' ],
            [ 'src' => asset('images/crystal.png'), 'title' => '8080 Genesis Crystals', 'price' => 'IDR 16.000' ],
        ];
    ?>
    ...
    <div class="hero">
        ...
        <div>
            ...
            <a class="muted" href="#" style="text-decoration: underline;">Cara Transaksi</a>
        </div>
    </div>
    ...
    <div class="layout">
        ...
        <div class="left-col">
            <!-- Step 1 -->
            <div class="panel">
                <div class="panel-title"><span class="step-badge">1</span> Masukkan UID dan Pilih Server</div>
                <div class="row" style="margin-bottom: 10px;">
                    <input class="input" type="text" placeholder="Masukkan UID">
                    <select class="select">
                ...
                <div class="muted">Untuk menemukan UID Anda, masuk aplikasi dan lihat pada profil Anda.</div>
            </div>
                    ...
                    @foreach ($produkTopup as $item)
                        <div class="product-card">
                            ...
                            <div class="product-body">
                                ...
                                <button class="btn" type="button">Pilih</button>
                            </div>
                        </div>
                    @endforeach
                </div>
        ...
        <div class="right-col">
                ...
                <div style="display:grid; gap:10px;">
                    ...
                    <div>
                        ...
                        <div class="row" style="gap:8px;">
                            ...
                            <button class="btn secondary" type="button">Cek Kode Promo</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="panel" style="margin-top: 14px;">
                <div style="font-weight:800; margin-bottom:8px;">Bagaimana Cara Top up Genesis Crystals?</div>
                <ol class="muted" style="padding-left: 18px; display:grid; gap:6px;">
                    <li>Klik di sini untuk memulai.</li>
                    <li>Selesaikan pembayaran.</li>
                    <li>Masukkan UID dan pilih server.</li>
